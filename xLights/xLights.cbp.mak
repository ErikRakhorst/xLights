...
INC_LINUX_DEBUG = $(INC) -Iinclude -Isequencer -I../xLights -Ieffects -Ieffects/ -Imodels -Ieffects/assist -I../include -Imodels/ -Isupport -Ioutputs -IxLights -IxLights/models -I../dependencies/libxlsxwriter/include -I../include/sol2-3.2.2
CFLAGS_LINUX_DEBUG =  -Wall -std=c++1z -g -std=gnu++17 `wx-config --version=3.1 --cflags` `pkg-config --cflags libavformat libavcodec libavutil  libswresample libswscale` `pkg-config --cflags gstreamer-1.0 gstreamer-video-1.0` `pkg-config --cflags lua` -Winvalid-pch -DWX_PRECOMP -DLINUX -DLUA_COMPAT_BITLIB -D__WXDEBUG__ -D__cdecl=""
...
LDFLAGS_LINUX_DEBUG =  -lGL -lGLU -lglut -ldl -lX11 -lcurl `pkg-config --libs libavformat libavcodec libavutil  libswresample libswscale` `pkg-config --libs log4cpp` `sdl2-config --libs` `wx-config --version=3.1 --libs std,media,gl,aui,propgrid` `pkg-config --libs gstreamer-1.0 gstreamer-video-1.0` `pkg-config --libs lua` -lexpat -rdynamic -lz -lzstd -lstdc++fs $(LDFLAGS)
OBJDIR_LINUX_DEBUG = .objs_debug
DEP_LINUX_DEBUG = 
OUT_LINUX_DEBUG = ../bin/xLights

INC_LINUX_RELEASE = $(INC) -Iinclude -Isequencer -I../xLights -Ieffects -Ieffects/ -Imodels -Ieffects/assist -I../include -Imodels/ -Isupport -Ioutputs -IxLights -IxLights/models -I../dependencies/libxlsxwriter/include -I../include/sol2-3.2.2
CFLAGS_LINUX_RELEASE = $(CFLAGS) -O2 -Wall -std=gnu++17 `wx-config --version=3.1 --cflags` `pkg-config --cflags gstreamer-1.0 gstreamer-video-1.0` `pkg-config --cflags libavformat libavcodec libavutil  libswresample libswscale` `pkg-config --cflags lua` -Winvalid-pch -DWX_PRECOMP -DLINUX -DNDEBUG -D__cdecl='' -Wno-reorder -Wno-sign-compare -Wno-unused-variable -Wno-unused-but-set-variable -Wno-unused-function -Wno-unknown-pragmas
...
$(OBJDIR_LINUX_DEBUG)/graphics/opengl/Image_Loader.o: graphics/opengl/Image_Loader.cpp
	$(CXX) $(CFLAGS_LINUX_DEBUG) $(INC_LINUX_DEBUG) -c graphics/opengl/Image_Loader.cpp -o $(OBJDIR_LINUX_DEBUG)/graphics/opengl/Image_Loader.o
...
$(OBJDIR_LINUX_DEBUG)/graphics/opengl/XlightsDrawable.o: graphics/opengl/XlightsDrawable.cpp
	$(CXX) $(CFLAGS_LINUX_DEBUG) $(INC_LINUX_DEBUG) -c graphics/opengl/XlightsDrawable.cpp -o $(OBJDIR_LINUX_DEBUG)/graphics/opengl/XlightsDrawable.o

$(OBJDIR_LINUX_DEBUG)/graphics/opengl/Image.o: graphics/opengl/Image.cpp
	$(CXX) $(CFLAGS_LINUX_DEBUG) $(INC_LINUX_DEBUG) -c graphics/opengl/Image.cpp -o $(OBJDIR_LINUX_DEBUG)/graphics/opengl/Image.o

$(OBJDIR_LINUX_DEBUG)/graphics/opengl/DrawGLUtils31.o: graphics/opengl/DrawGLUtils31.cpp
	$(CXX) $(CFLAGS_LINUX_DEBUG) $(INC_LINUX_DEBUG) -c graphics/opengl/DrawGLUtils31.cpp -o $(OBJDIR_LINUX_DEBUG)/graphics/opengl/DrawGLUtils31.o
...
$(OBJDIR_LINUX_RELEASE)/graphics/opengl/Image_Loader.o: graphics/opengl/Image_Loader.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c graphics/opengl/Image_Loader.cpp -o $(OBJDIR_LINUX_RELEASE)/graphics/opengl/Image_Loader.o
...
$(OBJDIR_LINUX_RELEASE)/graphics/opengl/XlightsDrawable.o: graphics/opengl/XlightsDrawable.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c graphics/opengl/XlightsDrawable.cpp -o $(OBJDIR_LINUX_RELEASE)/graphics/opengl/XlightsDrawable.o

$(OBJDIR_LINUX_RELEASE)/graphics/opengl/Image.o: graphics/opengl/Image.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c graphics/opengl/Image.cpp -o $(OBJDIR_LINUX_RELEASE)/graphics/opengl/Image.o

$(OBJDIR_LINUX_RELEASE)/graphics/opengl/DrawGLUtils31.o: graphics/opengl/DrawGLUtils31.cpp
	$(CXX) $(CFLAGS_LINUX_RELEASE) $(INC_LINUX_RELEASE) -c graphics/opengl/DrawGLUtils31.cpp -o $(OBJDIR_LINUX_RELEASE)/graphics/opengl/DrawGLUtils31.o
...
models/BaseObject.h: OutputModelManager.h models/ModelScreenLocation.h
...
models/SphereModel.cpp: models/SphereModel.h models/ModelScreenLocation.h xLightsVersion.h xLightsMain.h UtilFunctions.h ModelPreview.h
...
outputs/ArtNetOutput.cpp: outputs/ArtNetOutput.h outputs/OutputManager.h UtilFunctions.h outputs/ControllerEthernet.h Discovery.h
...
models/ImageObject.h: models/ViewObject.h

models/MeshObject.h: models/ViewObject.h

models/ViewObject.cpp: models/ViewObject.h models/Model.h

models/TreeModel.cpp: models/TreeModel.h models/ModelScreenLocation.h xLightsVersion.h xLightsMain.h UtilFunctions.h ModelPreview.h
...
SpecialOptions.h: ExternalHooks.h
...
outputs/KinetOutput.cpp: outputs/KinetOutput.h outputs/OutputManager.h UtilFunctions.h outputs/ControllerEthernet.h
...
effects/VideoPanel.cpp: effects/VideoPanel.h effects/EffectPanelUtils.h UtilFunctions.h ExternalHooks.h
...
effects/TextPanel.h: BulkEditControls.h effects/EffectPanelUtils.h
...
effects/WarpPanel.cpp: effects/WarpPanel.h effects/EffectPanelUtils.h
...
models/CubeModel.cpp: models/CubeModel.h models/ModelScreenLocation.h xLightsVersion.h xLightsMain.h UtilFunctions.h outputs/OutputManager.h outputs/Controller.h ModelPreview.h
...
graphics/opengl/Image_Loader.cpp: UtilFunctions.h ExternalHooks.h

graphics/opengl/xlGLCanvas.cpp: UtilFunctions.h ExternalHooks.h

graphics/opengl/DrawGLUtils.cpp: ExternalHooks.h
...
graphics/xlMesh.cpp: ExternalHooks.h
...
xLightsImportChannelMapDialog.cpp: xLightsImportChannelMapDialog.h sequencer/SequenceElements.h xLightsMain.h models/Model.h models/ModelGroup.h UtilFunctions.h ExternalHooks.h MediaImportOptionsDialog.h
...
sequencer/EffectsGrid.cpp: sequencer/EffectsGrid.h sequencer/MainSequencer.h sequencer/TimeLine.h sequencer/RowHeading.h xLightsMain.h sequencer/SequenceElements.h sequencer/Effect.h sequencer/EffectLayer.h sequencer/EffectDropTarget.h RenderCommandEvent.h BitmapCache.h effects/RenderableEffect.h UtilFunctions.h xLightsXmlFile.h EffectTimingDialog.h effects/GlediatorEffect.h effects/VideoEffect.h effects/PicturesEffect.h effects/ShaderEffect.h ColorManager.h models/Model.h PixelBuffer.h VideoReader.h
...
sequencer/RowHeading.cpp: sequencer/RowHeading.h xLightsVersion.h BitmapCache.h models/ModelGroup.h SelectTimingsDialog.h models/SubModel.h sequencer/MainSequencer.h sequencer/EffectsGrid.h ColorManager.h sequencer/SequenceElements.h xLightsMain.h NewTimingDialog.h VAMPPluginDialog.h UtilFunctions.h
...
effects/SingleStrandEffect.cpp: effects/SingleStrandEffect.h effects/SingleStrandPanel.h sequencer/Effect.h RenderBuffer.h UtilClasses.h effects/FX.h ../include/singleStrand-16.xpm ../include/singleStrand-64.xpm

ModelGroupPanel.cpp: ModelGroupPanel.h models/ModelManager.h models/ModelGroup.h LayoutPanel.h OutputModelManager.h xLightsMain.h UtilFunctions.h
...
ModelStateDialog.cpp: ModelStateDialog.h xLightsXmlFile.h NodesGridCellEditor.h ModelPreview.h DimmingCurve.h SevenSegmentDialog.h NodeSelectGrid.h models/Model.h xLightsApp.h UtilFunctions.h xLightsMain.h support/VectorMath.h models/CustomModel.h
...
PixelBuffer.cpp: PixelBuffer.h DimmingCurve.h models/ModelManager.h models/SingleLineModel.h models/ModelGroup.h UtilClasses.h AudioManager.h xLightsMain.h Parallel.h UtilFunctions.h DissolveTransitionPattern.h GPURenderUtils.h
...
RenderBuffer.cpp: RenderBuffer.h sequencer/Effect.h xLightsMain.h xLightsXmlFile.h UtilFunctions.h GPURenderUtils.h Parallel.h
...
BulkEditControls.cpp: BulkEditControls.h xLightsMain.h xLightsApp.h EffectsPanel.h sequencer/MainSequencer.h BulkEditSliderDialog.h BulkEditFontPickerDialog.h BulkEditColourPickerDialog.h UtilFunctions.h ExternalHooks.h

BulkEditColourPickerDialog.cpp: BulkEditColourPickerDialog.h

BufferSizeDialog.cpp: BufferSizeDialog.h ValueCurveDialog.h UtilFunctions.h xLightsMain.h PixelBuffer.h ExternalHooks.h
...
ColorPanel.cpp: xLightsMain.h ColorPanel.h ColorCurve.h effects/EffectPanelUtils.h UtilFunctions.h xLightsApp.h ExternalHooks.h

ColorManager.cpp: ColorManager.h xLightsMain.h

ColorCurveDialog.cpp: ColorCurveDialog.h xLightsMain.h xLightsVersion.h UtilFunctions.h xLightsApp.h ExternalHooks.h sequencer/MainSequencer.h
...
ControllerModelDialog.cpp: ControllerModelDialog.h xLightsMain.h UtilFunctions.h outputs/Output.h outputs/ControllerEthernet.h models/ModelManager.h models/Model.h outputs/Controller.h Pixels.h

AboutDialog.cpp: AboutDialog.h

AlignmentDialog.cpp: AlignmentDialog.h

AudioManager.cpp: AudioManager.h ExternalHooks.h Parallel.h

BatchRenderDialog.cpp: BatchRenderDialog.h ExternalHooks.h ../include/globals.h
...
GenerateCustomModelDialog.cpp: GenerateCustomModelDialog.h effects/VideoPanel.h xLightsVersion.h xLightsXmlFile.h outputs/OutputManager.h UtilFunctions.h xLightsMain.h ExternalHooks.h

GPURenderUtils.cpp: GPURenderUtils.h

CustomModelDialog.cpp: CustomModelDialog.h models/CustomModel.h WiringDialog.h wxModelGridCellRenderer.h UtilClasses.h UtilFunctions.h ExternalHooks.h ModelPreview.h
...
effects/GalaxyEffect.cpp: effects/GalaxyEffect.h effects/GalaxyPanel.h sequencer/Effect.h RenderBuffer.h UtilClasses.h Parallel.h ../include/galaxy-16.xpm ../include/galaxy-24.xpm ../include/galaxy-32.xpm ../include/galaxy-48.xpm ../include/galaxy-64.xpm
...
effects/PicturesPanel.cpp: effects/PicturesPanel.h effects/EffectPanelUtils.h effects/GIFImage.h ExternalHooks.h
...
automation/xLightsAutomations.cpp: xLightsMain.h xLightsVersion.h FSEQFile.h outputs/Controller.h outputs/ControllerEthernet.h LayoutPanel.h ViewsModelsPanel.h UtilFunctions.h ExternalHooks.h xLightsApp.h JukeboxPanel.h outputs/E131Output.h sequencer/MainSequencer.h
...
ValueCurveDialog.cpp: ValueCurveDialog.h xLightsMain.h ValueCurve.h xLightsVersion.h UtilFunctions.h xLightsApp.h ExternalHooks.h sequencer/MainSequencer.h sequencer/SequenceElements.h
...
SubModelsDialog.cpp: SubModelsDialog.h models/Model.h SubBufferPanel.h SubModelGenerateDialog.h NodeSelectGrid.h UtilFunctions.h xLightsApp.h models/ModelManager.h xLightsMain.h ModelPreview.h DimmingCurve.h AlignmentDialog.h support/VectorMath.h xLightsVersion.h models/SubModel.h
...
cad/CADModel.cpp: models/Model.h Pixels.h

TraceLog.cpp: TraceLog.h

UpdaterDialog.cpp: UpdaterDialog.h

UtilFunctions.cpp: UtilFunctions.h xLightsVersion.h ExternalHooks.h
...
controllers/FPP.cpp: ../include/zstd.h xLightsXmlFile.h models/CustomModel.h models/Model.h models/MatrixModel.h outputs/OutputManager.h outputs/Output.h outputs/E131Output.h outputs/DDPOutput.h outputs/KinetOutput.h outputs/ControllerEthernet.h outputs/ControllerSerial.h UtilFunctions.h xLightsVersion.h Parallel.h ExternalHooks.h FSEQFile.h Discovery.h TraceLog.h

controllers/FPPConnectDialog.cpp: xLightsMain.h xLightsXmlFile.h outputs/Output.h outputs/OutputManager.h UtilFunctions.h ExternalHooks.h outputs/ControllerEthernet.h FSEQFile.h Parallel.h Discovery.h

controllers/Falcon.cpp: outputs/OutputManager.h outputs/Output.h models/Model.h models/ModelManager.h outputs/ControllerEthernet.h outputs/DDPOutput.h UtilFunctions.h
